# Ruby (Rails) service for Wodby

Use Ruby (Rails) as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Ruby (Rails) service in the Wodby catalog.
...
4. Reference `rails` from your stack manifest.
